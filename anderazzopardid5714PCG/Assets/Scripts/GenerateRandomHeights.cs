...
public class GenerateRandomHeights : MonoBehaviour
{
    ...
    private float maxRandomHeightRange = 0.1f; // min is 0
                    ...
                    for(int x =0; x < terrainData.size.x; x += treeSpacing)
                    {
                        ...
                        for(int treeIndex = 0; treeIndex < trees.Length; treeIndex++)
                        {
                            ...
                            if(treeInstanceList.Count < maxTrees)
                            {
                                ...
                                float currentHeight = terrainData.GetHeight(x,z) / terrainData.size.y; //this is going to give us height value between 0 and 1
